        ...
        <div className="mt-10 grid gap-4 sm:mt-16 sm:gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature, i) => (
            <FadeIn key={feature.title} delay={i * 0.08}>
              <div className="group h-full rounded-lg border border-hairline bg-canvas p-5 transition-all duration-300 hover:border-primary/20 hover:shadow-[var(--shadow-md)] sm:p-8">
